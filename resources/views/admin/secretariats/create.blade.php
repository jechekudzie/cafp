                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-8">
                                <form action="/admin/staff" method="post" class="m-t-40"
                                      enctype="multipart/form-data" novalidate>
                                    {{csrf_field()}}

                                    <div class="form-group">
                                        <h5> staff name <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                    ...
                                    <div class="form-group">
                                        <h5> staff Position <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                    ...
                                    <div class="form-group">
                                        <h5> staff Bio <span class="text-danger">*</span></h5>
                                        <div class="controls">
