    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                ...
                <a href="/admin/events" class="btn btn-success"></i> BACK</a>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <form action="/admin/events/{{$event->id}}" method="post" class="m-t-40"
                            ...
                            <div class="col-3 col-md-3">
                                <div class="card">
                                    ...
                                    <img class="card-img-top img-responsive" src="{{asset($event->image)}}" alt="Card
                                    image
                                     cap">
                                    <div class="card-body">
                                        {{--
                                ...
                                <form action="/admin/events/{{$event->id}}/files" method="post" class="m-t-40"
                                      enctype="multipart/form-data" novalidate>
                                    @csrf
                                    <h3>Files</h3>
                                    <div class="form-group">
                                ...
                                <form action="/admin/events/{{$event->id}}/images" method="post" class="m-t-40"
                                      enctype="multipart/form-data" novalidate>
                                    @csrf
                                    <h3>Images</h3>
                                    <div class="form-group">
