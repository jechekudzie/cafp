                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                @endif
                                <h4 class="card-title">Board Member</h4>
                                {{--
                        ...
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-8">
                                <form action="/admin/board" method="post" class="m-t-40"
                                      enctype="multipart/form-data" novalidate>
                                    {{csrf_field()}}

                                    <div class="form-group">
                                        <h5> Board Member name <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                    ...
                                    <div class="form-group">
                                        <h5> Board Member Position <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                    ...
                                    <div class="form-group">
                                        <h5> Board Member Bio <span class="text-danger">*</span></h5>
                                        <div class="controls">
