    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                ...
                <a href="/admin/board" class="btn btn-success"></i> BACK</a>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <form action="/admin/board/{{$councilMember->id}}" method="post" class="m-t-40" enctype="multipart/form-data" novalidate>
                                    {{method_field('PATCH')}}
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name" value="{{$councilMember->name}}" class="form-control"
                                                   required
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="position" value="{{$councilMember->position}}" class="form-control"
                                                   required
                                                   data-validation-required-message="This field is required">
                                        </div>
                                        <div class="form-control-feedback">
                            ...
                            <div class="col-3 col-md-3">
                                <div class="card">
                                    ...
                                    <img class="card-img-top img-responsive" src="{{asset($councilMember->image)}}"
                                         alt="Card image cap">
                                    <div class="card-body">
                                        {{--
