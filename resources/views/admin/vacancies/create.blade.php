    ...
    <div class="container-fluid">
        ...
        <div class="row page-titles">
            <div class="col-md-5 align-self-center">
                <a href="{{url('/admin/vacancies')}}" class="btn btn-success"></i> BACK</a>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-8">
                                <form action="{{url('/admin/vacancies')}}" method="post" class="m-t-40"
                                    ...
                                    <div class="form-group">
                                        <h5> Job Description <span class="text-danger">*</span></h5>
                                        <div class="controls">
