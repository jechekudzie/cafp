                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                @endif
                                <h4 class="card-title">Thematic Area</h4>
                                {{--
                        ...
                        <div class="row">
                            <div class="col-2"></div>
                            <div class="col-8">
                                <form action="/admin/thematic_areas" method="post" class="m-t-40"
                                    ...
                                    <div class="form-group">
                                        <h5> Thematic Area <span class="text-danger">*</span></h5>
                                        <div class="controls">
