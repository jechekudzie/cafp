        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                @foreach($articles as $article)
                    <div style="height: 700px;" class="item {{$x == 0 ? 'active':''}}">
                        <img class="img-responsive" src="{{asset($article->image)}}">
                        <div class="carousel-caption">
                            <h5 style="margin-top:-350px;background-color: #FCC100;opacity: 0.9;">{!! $article->name !!}</h5>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <ul style="margin-top: -150px;opacity: 0.8" class="nav nav-pills nav-justified">
                        @foreach($articles as $article)
